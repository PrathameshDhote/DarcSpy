...
export class FoundPatternsList extends LitElement {
    ...
    render() {
        ...
        <div>
            ...
            <h2 style="color: ${this.results.countVisible ? "green" : "red"}">${this.results.countVisible}</h2>
            <ul>
...
// Define a custom element for the component so that it can be used in the HTML DOM.
customElements.define("Info about Dark Patterns", SupportedPatternsList);
...
export class PopupFooter extends LitElement {
    ...
    render() {
        return html`
        <div>
            ${brw.i18n.getMessage("textMoreInformation")}: <a href="https://dapde.de/" target="_blank">dhote.ip</a>.
        </div>
      `;
    }
}
